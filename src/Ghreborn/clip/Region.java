...
public class Region {
	...
	private static final WorldObject[] EXISTANT_OBJECTS = {
			new WorldObject(6943, 3257, 3290,0, 1),
			new WorldObject(6943, 3257, 3291,0, 1),
			new WorldObject(6943, 3257, 3288,0, 1),
			new WorldObject(6943, 3257, 3287,0, 1),
			new WorldObject(6943, 2529, 10019,0, 1),
			new WorldObject(6943, 2529, 10018,0, 1),
			new WorldObject(6943, 2529, 10017,0, 1),
			new WorldObject(6943, 2529, 10016,0, 1),
			new WorldObject(6943, 2529, 10015,0, 1),
			new WorldObject(2097, 3252, 3291,0, 0),
			new WorldObject(28869, 3733, 5656,0, 0),
			new WorldObject(2097, 3252, 3289,0, 0),
			new WorldObject(26181, 3256, 3292,0, 0),
			new WorldObject(29150, 3250, 3293,0, 0),
			new WorldObject(29241, 3247, 3293,0, 0),
			new WorldObject(26181, 3254, 3292,0, 0),
			new WorldObject(6943, 3257, 3290,0, 1),
			new WorldObject(6943, 3257, 3291,0, 1),
			new WorldObject(6943, 3257, 3288,0, 1),
			new WorldObject(6943, 3257, 3287,0, 1),
			...
			new WorldObject(26181, 3256, 3292,0, 0),
			new WorldObject(26181, 3254, 3292,0, 0),
			new WorldObject(11730, 2969, 3384,0, -1),
			new WorldObject(11732, 2969, 3381,0, -1),
			new WorldObject(14011, 2961, 3383,0, 1),
			new WorldObject(11731, 2961, 3380,0, 1),
			new WorldObject(11729, 2965, 3376,0, 0),
			new WorldObject(11731, 2961, 3380,0, 1),
			new WorldObject(11729, 2965, 3376,0, 0),
			new WorldObject(6943, 1779, 5498,0, 0),
			new WorldObject(11663, 1779, 5486,0, 0),
			new WorldObject(61, 1773, 5484,0, 0),
			new WorldObject(6943, 2385, 3485,0, 1),
			new WorldObject(6943, 2385, 3486,0, 1),
			new WorldObject(6943, 2385, 3487,0, 1),
			new WorldObject(6943, 2385, 3488,0, 1),
			new WorldObject(6943, 2385, 3489,0, 1),
			new WorldObject(6943, 2385, 3490,0, 1),
			new WorldObject(6943, 2385, 3491,0, 1),
			new WorldObject(24957, 2389, 3489,0, 1),
			new WorldObject(24957, 2389, 3490,0, 1),
			new WorldObject(24957, 2389, 3491,0, 1),
			new WorldObject(24957, 2389, 3492,0, 1),
			new WorldObject(24957, 2389, 3493,0, 1),
			new WorldObject(24957, 2389, 3494,0, 1),
			new WorldObject(24957, 2389, 3495,0, 1),
			new WorldObject(24957, 2389, 3481,0, 1),
			new WorldObject(24957, 2389, 3482,0, 1),
			new WorldObject(24957, 2389, 3483,0, 1),
			new WorldObject(24957, 2389, 3484,0, 1),
			new WorldObject(24957, 2389, 3485,0, 1),
			new WorldObject(24957, 2389, 3486,0, 1),
			new WorldObject(6943, 3270, 3351,0, 1),
			new WorldObject(6943, 3270, 3350,0, 1),
			new WorldObject(6943, 3270, 3349,0, 1),
			new WorldObject(6943, 3270, 3348,0, 1),
			new WorldObject(6943, 3270, 3347,0, 1),
			new WorldObject(6943, 2847, 5064,0, 2),
			new WorldObject(6943, 2848, 5064,0, 2),
	};
