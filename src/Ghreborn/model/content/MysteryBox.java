...
public class MysteryBox extends CycleEvent {
     ...
     */
    public MysteryBox(Client player) {
        this.player = player;
    }
    ...
    public void execute(CycleEventContainer container) {
        ...
        if (Misc.random(200) == 2 && player.getItems().getItemCount(19730) == 0 && player.summonId != 19730) {
            player.getPA().messageall("@red@" + player.playerName
