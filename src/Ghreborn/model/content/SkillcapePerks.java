...
public static boolean isWearingMaxCape(Client player) {
 ...
 */
public static void purchaseMaxCape(Client player) {
 ...
 */
public static void mixCape(Client player, String cape) {
