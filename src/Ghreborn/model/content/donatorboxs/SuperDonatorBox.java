...
public class SuperDonatorBox extends CycleEvent {

	public static final int DONATOR_BOX = 16543;
	 ...
	 */
	public SuperDonatorBox(Client player) {
		this.player = player;
	}
	...
	public void open() {
		...
		if (player.getItems().freeSlots() < 5) {
			player.sendMessage("You need atleast 5 free slots to open a Super Donator Box.");
			return;
		}
		if (!player.getItems().playerHasItem(DONATOR_BOX)) {
			player.sendMessage("You need a Super Donator Box for this");
			return;
		}
