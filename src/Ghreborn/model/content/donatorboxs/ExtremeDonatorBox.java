...
public class ExtremeDonatorBox extends CycleEvent {

	public static final int DONATOR_BOX = 16544;
	 ...
	 */
	public ExtremeDonatorBox(Client player) {
		this.player = player;
	}
	...
	public void open() {
		...
		if (player.getItems().freeSlots() < 10) {
			player.sendMessage("You need atleast 10 free slots to open a Super Donator Box.");
			return;
		}
		if (!player.getItems().playerHasItem(DONATOR_BOX)) {
			player.sendMessage("You need a Extreme Donator Box for this");
			return;
		}
	...
	public void execute(CycleEventContainer container) {
		...
		GameItem itemDouble3 = Misc.getRandomItem(itemList);
		GameItem itemDouble4 = Misc.getRandomItem(itemList);
		GameItem itemDouble5 = Misc.getRandomItem(itemList);
		GameItem itemDouble6 = Misc.getRandomItem(itemList);
		GameItem itemDouble7 = Misc.getRandomItem(itemList);
		GameItem itemDouble8 = Misc.getRandomItem(itemList);
		GameItem itemDouble9 = Misc.getRandomItem(itemList);
		GameItem itemDouble10 = Misc.getRandomItem(itemList);
		
		player.setRights(Rights.RESPECTED_DONATOR);
			//player.getItems().addItem(995, coins);
		player.DonatorPoints += 10000;
			...
			player.getItems().addItem(itemDouble3.getId(), itemDouble3.getAmount());
			player.getItems().addItem(itemDouble4.getId(), itemDouble4.getAmount());
			player.getItems().addItem(itemDouble5.getId(), itemDouble5.getAmount());
			player.getItems().addItem(itemDouble6.getId(), itemDouble6.getAmount());
			player.getItems().addItem(itemDouble7.getId(), itemDouble7.getAmount());
			player.getItems().addItem(itemDouble8.getId(), itemDouble8.getAmount());
			player.getItems().addItem(itemDouble9.getId(), itemDouble9.getAmount());
			player.getItems().addItem(itemDouble10.getId(), itemDouble10.getAmount());
