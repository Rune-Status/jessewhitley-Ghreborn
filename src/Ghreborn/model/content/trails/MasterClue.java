package Ghreborn.model.content.trails;
...
public class MasterClue {
	...
	public static void exchangeClue(Client player) {
		if (player.getItems().getItemCount(19835) > 0) {
	...
	public static void progressScroll(Client player) {
	...
	public static void generateRequirement(Client player) {
