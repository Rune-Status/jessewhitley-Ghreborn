...
public class DailyTaskKills {
	...
	public static void kills(Client player, int npcId) {
		switch (npcId) {
		//case 5744:
		//case 5762: //Shay
		...
		case 8030: //addy dragon
			DailyTasks.increase(player, PossibleTasks.ADDY_DRAGONS);
			break;
		case 8091: //rune dragon
			DailyTasks.increase(player, PossibleTasks.RUNE_DRAGONS);
			break;
		}
	}
}
