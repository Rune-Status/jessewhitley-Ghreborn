...
public abstract class ItemContainer {
	...
	/**
	 * Determines if this container permittes duplicate items. Items are deemed duplicates
	 * if the identification value of one {@link GameItem} matches another.
	 */
	...
	/**
	 * Determines if a certain item exists in the container. The amount of the item is checked as well.
	 * If the slot exceeds the maximum capacity or is less than 0 then false will be returned.
	 * 
