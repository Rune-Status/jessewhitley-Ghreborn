...
public class GroundItem {
	...
	public boolean globalItem, initialized;
	...
	/**
	 * The ground item must be displayed on a height level. The ground item
	 * can only appear on the height level its created on.
