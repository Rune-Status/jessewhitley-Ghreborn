...
/**
 * Represents the skull on the bounty hunter interface. The risk is the amount in gold coins
 * the player must be risking to obtain the skull.
 * 
...
public enum BountyHunterSkull {
	...
	NONE(-1, 28030, "None"),
	BRONZE(0, 28032, "V. Low"), 
	SILVER(1_000_000, 28034, "Low"),
	GREEN(3_000_000, 28036, "Medium"),
	BLUE(6_000_000, 28038, "High"),
	RED(10_000_000, 28040, "V. High");
