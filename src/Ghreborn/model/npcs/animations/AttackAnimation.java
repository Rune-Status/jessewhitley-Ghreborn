package Ghreborn.model.npcs.animations;
	...
	public static int handleEmote(int i) {
		...
		switch (NPCHandler.npcs[i].npcType) {
			...
			case 7697:
				return 7597;
			case 7699:
				return npcs[i].attackType == 2 ? 7610 : 7612;
			case 7700:
		...
		case Skotizo.SKOTIZO_ID:
			return npcs[i].attackType == 2 ? 69 : 4680;
		case 7585:
		...
		case 7145:
		case 7146:
			return npcs[i].attackType == 2 ? 7225
					: npcs[i].attackType == 1 ? 7227
							: npcs[i].attackType == 4 ? 7225 : 7239;

		case 5890: // Abyssal sire
			return npcs[i].attackType == 0 ? Misc.random(1) == 0 ? 5366 : 5369
					: npcs[i].attackType == 2 ? 5751
							: npcs[i].attackType == 4 ? 5367 : -1;
		...
		case 465: // Skeletal wyverns
			return npcs[i].attackType == 0 ? Misc.random(1) == 1 ? 2985 : 2986
					: npcs[i].attackType == 1 ? 2989
							: npcs[i].attackType == 4 ? 2988 : 2985;

		case 6618: // Crazy Archaeologist
			return npcs[i].attackType == 0 ? 423 : 2614;
		...
		case 6918:
		case 6919:
			return npcs[i].attackType == 0 ? 7192 : npcs[i].attackType == 2 ? 7193 : 7157;
		...
		case 6370: // Flambeed
			return 1750;
		case 6371: // Karamel
			return npcs[i].attackType == 1 ? 2075 : 1979;
		case 6372: // Dessourt
			return 3508;
		case 6373:
		case 6374:
		...
		case 319: // Corporeal Beast
			return npcs[i].attackType == 2 ? 1680
					: npcs[i].attackType == 4 ? 1680 : 1682;
		case 320:
			return 1689;
		...
		// God wars
		case 2205:
			return npcs[i].attackType == 2 ? 6970 : 6967;
		case 2206:
			return 6376;
		case 2207:
			return 7036;
		...
		case 2211:
			return 426;
		case 3428:
			return npcs[i].attackType == 1 ? 426 : 426;
		case 3429:
			return 428;
		case 2212:
			return 711;
		case 2215:
			return npcs[i].attackType == 0 ? 7018 : 7021;
		case 2216:
		case 2217:
		case 2218:
			return 6154;
		...
		case 2167:
			return 2611;
		case 3125:// 360
			return npcs[i].attackType == 2 ? 2647 : 2644;
		case 5247:
			return 5411;
		case 13: // wizards
			return 711;
        ...
        case VorkathConstants.SLEEPING_VORKATH_ID:
            Client player = (Client) PlayerHandler.players[Server.npcHandler.npcs[i].spawnedBy];
