package Ghreborn.model.npcs.boss.Cerberus;
...
public class Cerberus extends SingleInstancedArea {
	...
	public Cerberus(Client player, Boundary boundary, int height) {
	...
	public void cerberusSpecials() {
		...
		if (CERBERUS.HP < 400) {
			if (random == 1) {
				...
				NPCHandler.npcs[CERBERUS.index].forceChat("Aaarrrooooooo");
