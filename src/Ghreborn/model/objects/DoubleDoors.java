...
public class DoubleDoors {
	...
	public void changeLeftDoor(DoubleDoors d) {
		...
		if (xAdjustment != 0 || yAdjustment != 0) { 
			Server.globalObjects.add(new GlobalObject(-1, d.x, d.y, d.z, 0, 0, 0));
		}
		...
		Server.globalObjects.add(new GlobalObject(d.doorId, d.x, d.y, d.z, getNextLeftFace(d), 0, 0));
	...
	public void changeRightDoor(DoubleDoors d) {
		...
		Region.removeObject(d.originalId, d.originalX, d.originalY, d.z, d.originalFace, 0);
		Server.globalObjects.add(new GlobalObject(d.doorId, d.x, d.y, d.z, getNextRightFace(d), 0, 0));
