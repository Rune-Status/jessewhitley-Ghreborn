...
public enum Mineral {
			...
			COPPER(new int[] { 7484, 7453, 11961, 11960, 11962, 13709 }, "bronze", 1, 18, 5, 5, 15, 15000, true, generateExclusive(436)), 
			...
			SILVER(new int[] { 7457, 7490 }, "silver", 20, 40, 5, 8, 17, 14800, true, generateExclusive(442)), 
			COAL(new int[] { 7489, 9717, 7456, 9718, 9719, 2096, 13714, 13706 }, "none", 30, 50, 3, 15, 29, 14600, true, generateExclusive(453)), 
			...
			ESSENCE(new int[] { 7471, 14912 }, "none", 1, 5, -1, -1, 5, 15000, false, generateExclusive(-1)),
			AMETHYST(new int[] { 30371, 30372 }, "none", 92, 140, 0, 100, 40, 11500, false, generateExclusive(21347)),			
			GEM(new int[] { 9030, 7464 }, "none", 40, 60, 20, 25, 20, 15000, true, new MineralReturn() {
