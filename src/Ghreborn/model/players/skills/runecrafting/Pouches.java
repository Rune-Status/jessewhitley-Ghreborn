...
public class Pouches {
	 ...
	 */
	public static void fill(Client player, Pouch pouch, int pouchId, int size) {
...
/*		if (player.getInterfaceEvent().isActive()) {
	 ...
	 */
	public static void empty(Client player, Pouch pouch, int pouchId, int size) {
/*		if (player.getInterfaceEvent().isActive()) {
			player.sendMessage("Please finish what you're doing.");
			return;
		}*/
	...
	public static void check(Client player, Pouch pouch, int pouchId, int size) {
