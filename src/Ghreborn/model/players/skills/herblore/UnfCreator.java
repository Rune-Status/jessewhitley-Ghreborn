...
public class UnfCreator {
	...
	public static boolean setPotionToCreate(final Client player, final GameItem itemUsed) {
	...
	public static boolean makeUnfinishedPotion(final Client player, final GameItem itemUsed) {
		final UnfinishedPotions unf = UnfinishedPotions.forId(itemUsed.getId());
		if (unf == null) {
			return false;
		}
