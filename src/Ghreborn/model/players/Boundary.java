...
public class Boundary {
	...
	public static final Boundary WARRIORS_GUILD_BASEMENT = new Boundary(2904, 9956, 2941, 9974);
	...
	public static final Boundary SKOTIZO_BOSSROOM = new Boundary(1678, 9870, 1714, 9905);
		...
		public static final Boundary DONATOR_ZONE = new Boundary(1280, 5440, 1344, 5503);
		/*
		 * Cerberus spawns
		 */
