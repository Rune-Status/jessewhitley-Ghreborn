...
public class MagicConfig {
	...
	public static boolean waterSpells(Client c) {
		switch (MagicData.MAGIC_SPELLS[c.oldSpellId][0]) {
		case 1154:
		case 1163:
		case 1175:
	...
	public static boolean airSpells(Client c) {
		switch (MagicData.MAGIC_SPELLS[c.oldSpellId][0]) {
		// case 1152:
		case 1160:
		case 1172:
	...
	public static boolean fireSpells(Client c) {
		switch (MagicData.MAGIC_SPELLS[c.oldSpellId][0]) {
		case 1158:
		case 1169:
		case 1181:
	...
	public static boolean earthSpells(Client c) {
		switch (MagicData.MAGIC_SPELLS[c.oldSpellId][0]) {
		case 1156:
		case 1166:
		case 1177:
	...
	public static boolean shadowSpells(Client c) {
		switch (MagicData.MAGIC_SPELLS[c.spellId][0]) {
		case 32:
		case 36:
		case 40:
