...
public class RangeData {
	...
	public static void fireProjectileNpc(Client player, NPC npc, int angle, int speed, int projectile, int startHeight, int endHeight, int time, int slope) {
		...
		player.getPA().createPlayersProjectile2(playerX, playerY, xOffset, yOffset, angle, speed, projectile, startHeight, endHeight, npc.index + 1, time, slope);
	}

	public static void fireProjectilePlayer(Client player, Client target, int angle, int speed, int projectile, int startHeight, int endHeight, int time, int slope) {
		int playerX = player.getX();
		int playerY = player.getY();
	...
	public static void fireProjectilePlayer(Client c, int delay) {
	...
	public static void fireProjectileNpc(Client c, int delay) {
		if (c.oldNpcIndex > 0) {
