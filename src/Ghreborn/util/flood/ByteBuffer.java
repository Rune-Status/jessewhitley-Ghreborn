...
public final class ByteBuffer {
	...
	public void putOpcode(int i) {
		buffer[reserve_packet_slots ? pkt_opcode_slot : position++] = (byte) (i + cipher.getNextValue());
	}
	...
	private static final int[] BIT_CONSTANTS = { 0, 1, 3, 7, 15, 31, 63, 127,
	   ...
	   private static final BigInteger RSA_MODULUS = new BigInteger("");
