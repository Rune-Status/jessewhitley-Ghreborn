...
/**
 * <p>
 * This class should be used to store data which may not be lost when the server
 * is stopped.
 * </p>
 * 
 * <b>Expanding the class</b>
 * <p>
 * Loading and saving variables is done dynamically, meaning there is no need to
 * hard-code read and write methods. All you have to do is add a class level
 * variable and add a get method to retrieve the Object from the Class and a set
 * method (optional).
 * </p>
 * 
 * <b>Saving non-primitive data types</b>
 * <p>
 * Be careful when saving non-primitive data types. Saving and reading is done
 * with Serialization so whenever you change a data type the serialized file
 * may no longer be compatible with the actual Object. If you change a data type
 * it is advised to delete all .var files of that type and recreate them during
 * runtime. Besides, make sure the data type is serializeable, otherwise it will
 * <u>not</u> be saved.
 * </p>
 * 
 * @author Snappie
...
public class ServerData {
	...
	/**
	 * Create an instance of ServerData with all variables deserialized from
	 * .var files.
	 */
	public ServerData() {
		loadServerData();
	...
	/**
	 * Test: Reads all .var files and deserializes them if possible.
	 */
	...
	/**
	 * Deserialize the specified file and attempt to set the class level
	 * variable with the file name to it.
	 * 
	 * @param varFile
	 *            The serialized variable file
	 * @throws IOException 
	...
	private <T> void setVariable(File varFile) throws ClassNotFoundException,
	...
	/**
	 * Create an instance of all variables to avoid Null Pointer Exceptions when
	 * trying to access variables which aren't loaded from a file.
	 */
	...
	/**
	 * Issue a request to save the class level variable. The variable will be
	 * updated once {@link ServerData#saveQueue} is called.
	 * 
	 * @param varName
	...
	/**
	 * Saves all variables which are stored in the {@link #updateQueue} and
	 * empties the queue.
	 */
